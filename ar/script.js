...
async function submitPrestoLead() {
    ...
    if (!value) {
       ...
       showValidationPopup(
           "المعلومات المطلوبة",
           "يرجى إدخال عنوان البريد الإلكتروني أو رقم الهاتف المحمول"
       );
    ...
    showSuccessPopup(
       "مرحباً بكم في عائلة PRESTO!",
       "شكراً لانضمامك إلينا. ستتلقى عروضاً حصرية، وإشعارات بإطلاق منتجات جديدة، وتحديثات خاصة."
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            "تم إرسال الرسالة!",
            "شكراً لتواصلكم مع PRESTO. سنرد عليكم في أقرب وقت."
        );
