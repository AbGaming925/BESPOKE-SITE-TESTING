...
const BASE_PATH = document.documentElement.lang === "en" ? "" : "../";

const NO_IMAGE = BASE_PATH + "assets/images/no-image.png";
...
function getWhatsAppLink(product) {
    ...
    return `https://wa.me/919830015400?text=${encodeURIComponent(
        `Hello PRESTO,
...
function noProducts() {
    ...
    <div class="product-card no-product-card">

        <div class="no-product-preview">

            <img
                src="${BASE_PATH}assets/images/no-image.png"
                alt="No Products"
            ...
            <p>
                Товары для этой категории будут добавлены в ближайшее время.
            </p>
