...
async function submitPrestoLead() {
    ...
    showSuccessPopup(
       "Добро пожаловать в семью PRESTO!",
       "Спасибо, что присоединились к нам. Вы будете получать эксклюзивные предложения, информацию о новинках и специальные уведомления."
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            ...
            "Благодарим вас за обращение в PRESTO. Мы свяжемся с вами в ближайшее время."
        );
