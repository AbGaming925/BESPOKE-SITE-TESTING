...
async function submitPrestoLead() {
    ...
    if (!value) {
       ...
       showValidationPopup(
           "जानकारी आवश्यक",
           "कृपया अपनी ईमेल आईडी या मोबाइल नंबर डालें।"
       );
    ...
    showSuccessPopup(
       "PRESTO परिवार में आपका स्वागत है!",
       "हमारे साथ जुड़ने के लिए धन्यवाद। आपको खास ऑफ़र, नए प्रोडक्ट की लॉन्चिंग और खास अपडेट्स मिलेंगे।"
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            "संदेश भेजा गया!",
            "PRESTO से संपर्क करने के लिए धन्यवाद। हम जल्द ही आपसे संपर्क करेंगे।"
        );
