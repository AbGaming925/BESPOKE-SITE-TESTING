...
async function submitPrestoLead() {
    ...
    showSuccessPopup(
       "¡Bienvenido a la familia PRESTO!",
       "Gracias por unirte a nosotros. Recibirás ofertas exclusivas, lanzamientos de productos y actualizaciones especiales."
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            "¡Mensaje enviado!",
            "Gracias por contactar a PRESTO. Nos pondremos en contacto con usted en breve."
        );
