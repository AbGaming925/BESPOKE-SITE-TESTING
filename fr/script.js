...
async function submitPrestoLead() {
    ...
    if (!value) {
       ...
       showValidationPopup(
           ...
           "Veuillez saisir votre adresse e-mail ou votre numéro de mobile."
       );
    ...
    showSuccessPopup(
       "Bienvenue dans la famille PRESTO !",
       "Merci de nous avoir rejoints. Vous recevrez des offres exclusives, des informations sur les lancements de produits et des actualités spéciales."
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            "Message envoyé !",
            "Merci d'avoir contacté PRESTO. Nous reviendrons vers vous sous peu."
        );
