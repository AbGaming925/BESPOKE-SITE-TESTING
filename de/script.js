...
async function submitPrestoLead() {
    ...
    if (!value) {
       ...
       showValidationPopup(
           ...
           "Bitte geben Sie Ihre E-Mail-Adresse oder Mobilnummer ein."
       );
    ...
    showSuccessPopup(
       "Willkommen in der PRESTO-Familie!",
       "Vielen Dank, dass Sie dabei sind. Sie erhalten exklusive Angebote, Informationen zu Produktneuheiten und besondere Updates."
    );
...
if(contactForm){
    ...
    contactForm.addEventListener("submit", async function(e){
        ...
        showSuccessPopup(
            "Nachricht gesendet!",
            "Vielen Dank, dass Sie sich an PRESTO gewandt haben. Wir werden uns in Kürze bei Ihnen melden."
        );
